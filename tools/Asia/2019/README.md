...
🔗 **Link:** [Ghosts in the Browser: Backdooring with Service Workers](https://github.com/clod81/block_service_workers)  
📝 **Description:** A Chrome extension that prevents Service Workers from being registered on websites, developed to mitigate browser backdooring techniques that abuse the Service Worker API.
...
🔗 **Link:** [ModSecurity 3.1: Stepping up the Game for Web Attacks](https://github.com/owasp-modsecurity/ModSecurity)  
...
🔗 **Link:** [npm-scan: An Extensible, Heuristic-Based Vulnerability Scanning Tool for Installed NPM Packages](https://github.com/spaceraccoon/npm-scan)  
📝 **Description:** An extensible, heuristic-based vulnerability scanning tool for installed npm packages. Active heuristics-based scanning: quick and easy for anyone to use Improves/enforces quality of open source coding
...
🔗 **Link:** [pytm: A Pythonic Framework for Threat Modeling](https://github.com/owasp/pytm)  
...
🔗 **Link:** [Maltego: FullContact](https://github.com/cmlh/Maltego-FullContact)  
...
🔗 **Link:** [RTS: Real Time Scrapper](https://github.com/RTSPlus/rts-scraper)  
...
🔗 **Link:** [Squatm3gator: 360° Cybersquatting](https://github.com/david3107/squatm3gator)  
...
🔗 **Link:** [ACSploit: Exploit Algorithmic Complexity Vulnerabilities](https://github.com/twosixlabs/acsploit)  
📝 **Description:** An interactive command-line utility that generates worst-case inputs to commonly used algorithms, crafted to cause target programs to consume excessive computational resources such as time or memory.
...
🔗 **Link:** [GyoiThon: Penetration Testing Using Machine Learning](https://github.com/gyoisamurai/GyoiThon)  
...
🔗 **Link:** [CQTools: The New Ultimate Hacking Toolkit](https://github.com/blackdiverx/cqtools)  
📝 **Description:** A collection of security and system administration tools for Windows, including utilities for decryption, credential dumping, registry manipulation, and other system-level operations.
...
🔗 **Link:** [MLsploit: A Cloud-Based Framework for Adversarial Machine Learning Research](https://github.com/mlsploit)  
📝 **Description:** A cloud-based framework for interactive experimentation with adversarial machine learning research, providing a dockerized system with a REST API backend and web interface for studying ML vulnerabilities and attacks.
...
🔗 **Link:** [NFC Scrambler](https://github.com/nfc-tools)  
...
🔗 **Link:** [Unprotect Project: Unprotect Malware for the Mass](https://github.com/fr0gger/unprotect)  
...
🔗 **Link:** [Weapons of Office Destruction: Prevention with Machine Learning](https://github.com/GurpreetKukkar/Weapon-Detection-using-Artificial-Intelligence)  
...
![Asia 2019](https://img.shields.io/badge/Asia%202019-green) ![Category: 🟣 Red Teaming / Embedded](https://img.shields.io/badge/Category:%20🟣%20Red%20Teaming%20/%20Embedded-purple) ![Emilio Couto](https://img.shields.io/badge/Emilio%20Couto-informational)

🔗 **Link:** [CIRCO: Cisco Implant Raspberry Controlled Operations](https://github.com/ekiojp/circo)  
...
🔗 **Link:** [IoT Hunter: A Framework Tool for Building IoT Threat Intelligence System](https://github.com/emergingthreats/iot-hunter)  
...
![Asia 2019](https://img.shields.io/badge/Asia%202019-green) ![Category: 🟣 Red Teaming / Embedded](https://img.shields.io/badge/Category:%20🟣%20Red%20Teaming%20/%20Embedded-purple) ![Jie Feng Ho](https://img.shields.io/badge/Jie%20Feng%20Ho-informational) ![Ragul Balaji Velusamy Sathiakumar](https://img.shields.io/badge/Ragul%20Balaji%20Velusamy%20Sathiakumar-informational) ![Andre Ng](https://img.shields.io/badge/Andre%20Ng-informational)

🔗 **Link:** [RF-Xfil: Prototype Toolkit for Data Exfiltration Over Radio Frequencies](https://github.com/ragulbalaji/RF-Xfil)  
📝 **Description:** A prototype toolkit for data exfiltration over radio frequencies, demonstrating how a malicious USB-to-VGA dongle driver could secretly transmit data wirelessly using modulation techniques compatible with inexpensive RTL-SDR receivers.
...
🔗 **Link:** [VxHunter: A Tool Set for VxWorks Based Embedded Device Analyses](https://github.com/pagalaxylab/vxhunter)  
...
🔗 **Link:** [DaaS: Decompilation as a Service](https://github.com/sunsmarterjie/daas)  
...
🔗 **Link:** [ProcJack + Clove: Non-Invasive Code Instrumentation](https://github.com/msmania/procjack)  
