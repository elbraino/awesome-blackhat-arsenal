# Asia 2021
---
📍 22 tools demonstrated at **Black Hat Arsenal Asia 2021**, grouped by track category. Expand a tool for its description.
...
---
## 🌐 Web/AppSec
<details><summary><strong>Threagile: The Open-Source Agile Threat Modeling Toolkit</strong> — Christian Schneider</summary>

**Track:** Web AppSec · **Event:** Asia 2021  
...
<details><summary><strong>KICS</strong> — Erez Yalon, Ori Bendet</summary>

**Track:** Code Assessment · **Event:** Asia 2021  
...
---
## 📱 Mobile Security
<details><summary><strong>AOP-Based Runtime Security Analysis Toolkit</strong> — Juhu Nie, Hao Zhao</summary>

**Track:** Android, iOS and Mobile Hacking · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/alipay/AOP-Based-Runtime-Security-Analysis-Toolkit](https://github.com/alipay/AOP-Based-Runtime-Security-Analysis-Toolkit)  
...
---
## 🔍 OSINT
<details><summary><strong>GitDorker: I'm in Your GitHub Dorking All Your Secrets</strong> — Omar Bheda</summary>

**Track:** OSINT - Open Source Intelligence · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/obheda12/gitdorker](https://github.com/obheda12/gitdorker)  
...
<details><summary><strong>Quark Engine: Storyteller of Android Malware</strong> — JunWei Song, KunYu Chen, YuShiang Dang, IokJin Sih</summary>

**Track:** OSINT - Open Source Intelligence · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/ev-flow/quark-engine](https://github.com/ev-flow/quark-engine)  
...
---
## 🔴 Red Teaming
<details><summary><strong>CANalyse: A Vehicle Network Analysis and Attack Tool</strong> — Kartheek Lade</summary>

**Track:** Exploitation and Ethical Hacking · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/KartheekLade/CANalyse](https://github.com/KartheekLade/CANalyse)  
...
<details><summary><strong>CDK: Zero Dependency Container Penetration Toolkit</strong> — Yue Xu, Zebin Zhou</summary>

**Track:** Exploitation and Ethical Hacking · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/cdk-team/CDK](https://github.com/cdk-team/CDK)  
...
<details><summary><strong>Empire: Post-Exploitation Framework</strong> — Anthony Rose, Jake Krasnov</summary>

**Track:** Network Attacks · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/EmpireProject/Empire](https://github.com/EmpireProject/Empire)  
...
<details><summary><strong>OWFuzz: WiFi Protocol Fuzzing Tool Based on OpenWiFi</strong> — Hongjian Cao</summary>

**Track:** Network Attacks · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/alipay/Owfuzz](https://github.com/alipay/Owfuzz)  
...
<details><summary><strong>Red Kube</strong> — Or Azarzar</summary>

**Track:** Exploitation and Ethical Hacking · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/lightspin-tech/red-kube](https://github.com/lightspin-tech/red-kube)  
...
---
## 🔴 Red Teaming / AppSec
<details><summary><strong>Adversarial Threat Detector</strong> — Isao Takaesu</summary>

**Track:** Vulnerability Assessment · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/gyoisamurai/Adversarial-Threat-Detector](https://github.com/gyoisamurai/Adversarial-Threat-Detector)  
...
<details><summary><strong>Demystifying the State of Kubernetes Cluster Security - The Cloud Native Way</strong> — Vasant Chinnipilli, Rupali Dash</summary>

**Track:** Vulnerability Assessment · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/Metarget/awesome-cloud-native-security](https://github.com/Metarget/awesome-cloud-native-security)  
...
---
## 🔵 Blue Team & Detection
<details><summary><strong>FalconEye: Windows Process Injection Techniques - Catch Them All</strong> — Rajiv Kulkarni, Rex Guo, Sushant Paithane</summary>

**Track:** Malware Defense · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/rajiv2790/falconeye](https://github.com/rajiv2790/falconeye)  
📝 **Description:** Process injection (PI) in Windows has been a well-known security topic for many years. It is used to gain more stealth because it does not create additional processes in the system that could attract unwanted attention from the defender. It is also used to bypass security products that have limited visibility into the injection behaviors. Since PI techniques use legitimate windows APIs, detecting them becomes a challenging task. FalconEye provides comprehensive detection for true PI techniques in real-time. True PIs inject into target processes which are already running. Pre-execution injections such as AppInit and process hollowing are not in scope. To the best of our knowledge, we analyzed all the publicly known PI techniques and our tool is able to detect all of them without false positives during our testing. We identify PI behavior invariants that are unique compared to benign program behaviors but are common between various PI techniques. Based on the behavior invariants, we divide PI detections into three classes: (1) Stateless detection (2) Stateful detection (3) Floating code detectionWe propose a comprehensive detection algorithm to detect these behavior invariants classes. Our detection algorithm relies on two instrumentation primitives: (1) System call interception (2) Kernel callbacksBased on our testing, the detection is compatible with Windows 10 1903 and previous versions. Evaluation results show that the detection is effective and has low overhead. Additionally, the generic detection mechanisms are also proven to detect newer PI techniques. GitHub - rajiv2790/FalconEye

</details>

<details><summary><strong>Identify iOS Malicious Code Based on MachO File Structure</strong> — Shijie Cao</summary>

**Track:** Malware Defense · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/SecurityLife/iOS_Malicious_Bit_Hunter](https://github.com/SecurityLife/iOS_Malicious_Bit_Hunter)  
...
<details><summary><strong>LIFARS IOC-Checker + Log-Checker = Accelerate Your DFIR With the Power of Threat Intelligence</strong> — Viliam Kacala, Ladislav Baco</summary>

**Track:** Data Forensics/Incident Response · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/Lifars/log-checker](https://github.com/Lifars/log-checker)  
...
<details><summary><strong>Project Enigma: Detecting Indicators of Compromise Through Ram Analysis, Event Logs and Malware Machine Learning</strong> — Kevin Tan, Patrick Kang Wei Sheng, Wei Han Goh</summary>

**Track:** Data Forensics/Incident Response · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/mikepound/enigma](https://github.com/mikepound/enigma)  
...
<details><summary><strong>Suricata: An Open-Source IDS/IPS/NSM Engine</strong> — Josh Stroschein, Peter Manev</summary>

**Track:** Network Defense · **Event:** Asia 2021  
...
<details><summary><strong>Drone Monitoring and Takedown System (DMTS)</strong> — Pengfei Yu, Anders Soh, Yong Wen Chan</summary>

**Track:** Hardware/Embedded · **Event:** Asia 2021  
🔗 **Link:** Not Available  
...
<details><summary><strong>Scared: A Side-Channel Attacks Framework</strong> — Benjamin Timon</summary>

**Track:** Hardware/Embedded · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/eshard/scared](https://github.com/eshard/scared)  
...
---
## 🧠 Reverse Engineering
<details><summary><strong>Ghidra-EVM: Reversing Smart Contracts with Ghidra</strong> — Antonio de la Piedra</summary>

**Track:** Reverse Engineering · **Event:** Asia 2021  
🔗 **Link:** [https://github.com/adelapie/ghidra-evm](https://github.com/adelapie/ghidra-evm)  
...
<details><summary><strong>Qiling: Smart Analysis for Smart Contract</strong> — KaiJern Lau, ChenXu Wu, ZiQiao Kong</summary>
...
<details><summary><strong>SniperPhish: The Web-Email Spear Phishing Toolkit</strong> — Gem George</summary>

**Track:** Human Factors · **Event:** Asia 2021  
🔗 **Link:** Not Available  
